import { Mail, Phone, MapPin, Download, Send, Facebook, Linkedin, Github, Globe, Menu, X, Leaf } from 'lucide-react';
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    placeholder.innerHTML = `
                      ...
                      <p class="text-[10px] font-black uppercase tracking-widest leading-tight">يرجى رفع صورتك<br/>profile-formal.png</p>
                    `;
